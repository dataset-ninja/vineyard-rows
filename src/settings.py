...
##################################
PROJECT_NAME: str = "Vineyard Rows"
PROJECT_NAME_FULL: str = "Semantic Segmentation Vineyard Rows"
...
RELEASE_DATE: Optional[str] = "2021-03-12"  # e.g. "YYYY-MM-DD"
...
REPOSITORY: Optional[Union[str, List[str], Dict[str, str]]] = {
    "GitHub": "https://github.com/MrD1360/deep_segmentation_vineyards_navigation/tree/main"
}
